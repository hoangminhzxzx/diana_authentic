...
<?php $__env->startSection('content'); ?>
    <div class="row">
        <div class="card mx-4 col-6" id="form_edit_stock">
            ...
            <div class="card-body">
                <form action="<?php echo e(route('admin.stock.update', ['id' => $stock->id])); ?>" method="POST" enctype="multipart/form-data" id="stockFormEdit" class="">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.layout_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xamp\htdocs\diana_authentic\resources\views/admin/stock/edit.blade.php ENDPATH**/ ?>