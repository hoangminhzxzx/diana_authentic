...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(url('/public/plugins/custom/splide/dist/css/splide.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(url('/public/plugins/custom/splide/dist/css/themes/splide-default.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(url('/public/plugins/custom/splide/dist/css/splide-core.min.css')); ?>">
</head>
<body>
<?php
                    ...
                    <?php if(session()->has('client_login')): ?>
                        <li class="dropdown" onclick="showSubMenu(this)">
                            ...
                            <ul class="d-none" id="sub_menu">
                                ...
                                <li class="item-single-menu">
                                    <a href="<?php echo e(route('client.account.changPassword')); ?>" class="">Đổi mật khẩu</a>
                                </li>
                                <li class="item-single-menu">
...
<script src="<?php echo e(url('/public/plugins/custom/splide/dist/js/splide.js')); ?>"></script>
