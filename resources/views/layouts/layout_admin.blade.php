    ...
    <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <li class="nav-item">
            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <a class="collapse-item" href="{{route('admin.product.add')}}">Tạo mới</a>
        ...
        <li class="nav-item">
            ...
            <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    <a class="collapse-item" href="{{route('category-tree-view')}}">Tạo mới</a>
...
{{--        </li>--}}
{{--        <li class="nav-item">--}}
{{--            <a class="nav-link collapsed" href="{{route('admin.user.list')}}" aria-expanded="true" aria-controls="collapseUsers">--}}
{{--                <i class="fas fa-users"></i>--}}
{{--                <span>Users</span>--}}
{{--            </a>--}}
{{--        </li>--}}
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="{{ route('admin.product.config.product') }}">
                <i class="fas fa-fw fa-wrench"></i>
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="{{ route('admin.stock.index') }}">
